<?php
/**
 * team03 customizer sanitization functions
 *
 * @package team03
 * @subpackage team03
 * @since 0.3
 ...
 */
function team03_sanitize_select( $input, $setting ) {
 ...
 */
function team03_sanitize_image( $image, $setting ) {
	/*
 ...
 *                    the setting default.
 */
function team03_sanitize_number_range( $number, $setting ) {
...
* @since team03 0.3
*/
function team03_sanitize_page( $input ) {
 ...
 */
function team03_sanitize_checkbox( $checked ) {
 ...
 * @since team03 0.3
 */
function team03_sanitize_category_list( $input ) {
	if ( $input != '' ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 */
function team03_santize_allow_tag( $input, $setting ) {
 ...
 * @return string The input with only allowed tag i.e. anchor
 */
function team03_santize_line_break( $input ) {
	$input = wp_kses( $input, array(
		'br' => array()
		) );
