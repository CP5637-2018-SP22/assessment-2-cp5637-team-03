...
if ( ! function_exists( 'team03_add_top_bar' ) ) :
    /**
     * Add top bar section
     *
     * @since team03 0.6
     */
    function team03_add_top_bar() {
      ...
      $section_details = apply_filters( 'team03_filter_top_bar_section_details', $section_details );
      ...
      team03_render_top_bar( $section_details );
    }
endif;
add_action( 'team03_top_bar', 'team03_add_top_bar', 10 );


if ( ! function_exists( 'team03_top_bar_section_details' ) ) :
    /**
     ...
     */
    function team03_top_bar_section_details( $input ) {
        $options = team03_get_theme_options();
...
add_filter( 'team03_filter_top_bar_section_details', 'team03_top_bar_section_details' );


if ( ! function_exists( 'team03_render_top_bar' ) ) :
    /**
     * Add top bar
     *
     * @since team03 0.6
     */
    function team03_render_top_bar( $section_details ) { 
      $options = team03_get_theme_options();
