 ...
 * @since team03 0.3
 */
if ( ! function_exists( 'team03_add_partner' ) ) :
  /**
   * Add Partners
   *
   *@since team03 0.3
   */
  function team03_add_partner() {

    // Check if partner is enabled on frontpage
    $partner_enable = apply_filters( 'team03_section_status', true, 'partner_enable' );
    if ( true !== $partner_enable ) {
      return false;
    }
    // Get Partners details
    $section_details = array();
    $section_details = apply_filters( 'team03_filter_partner_details', $section_details );
    ...
    // Render Partners now.
    team03_render_partner( $section_details );
  }
endif;
add_action( 'team03_footer_content', 'team03_add_partner', 10 );


if ( ! function_exists( 'team03_get_partner_details' ) ) :
  /**
   * Partners details.
   *
   * @since team03 0.3
   ...
   */
  function team03_get_partner_details( $input ) {
...
add_filter( 'team03_filter_partner_details', 'team03_get_partner_details' );


if ( ! function_exists( 'team03_render_partner' ) ) :
  /**
   ...
   *
   */
   function team03_render_partner( $content_details = array() ) {
        $options = team03_get_theme_options();  
