 ...
 * @since team03 0.3
 */
if ( ! function_exists( 'team03_add_category_blog_three' ) ) :
  /**
   * Add Category Blog three
   *
   *@since team03 0.3
   */
  function team03_add_category_blog_three() {

    // Check if cat blog three is enabled on frontpage
    $category_blog_one_enable = apply_filters( 'team03_section_status', true, 'category_blog_one_enable' );
    ...
    $section_details = apply_filters( 'team03_filter_category_blog_three_details', $section_details );
    ...
    team03_render_category_blog_three( $section_details );
  }
endif;
add_action( 'team03_primary_content', 'team03_add_category_blog_three', 20 );


if ( ! function_exists( 'team03_get_category_blog_three_details' ) ) :
  /**
   ...
   */
  function team03_get_category_blog_three_details( $input ) {
    ...
    switch ( $category_blog_one_type ) {
        ...
        case 'sub-category':
            ...
            foreach( $categories as $category ){
                ...
                $content[$i]['icon']    = esc_attr__( 'fa-snapchat-ghost', 'team03');
...
add_filter( 'team03_filter_category_blog_three_details', 'team03_get_category_blog_three_details' );


if ( ! function_exists( 'team03_render_category_blog_three' ) ) :
  /**
   ...
   *
   */
   function team03_render_category_blog_three( $content_details = array() ) {
        $options                        = team03_get_theme_options();
